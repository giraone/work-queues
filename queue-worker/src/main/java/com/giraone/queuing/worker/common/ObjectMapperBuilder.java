package com.giraone.queuing.worker.common;
...
public class ObjectMapperBuilder {
    ...
    public static ObjectMapper build(boolean snakeCase, boolean sortKeys, boolean bigNumberAsString) {
    ...
    public static ObjectMapper build(boolean snakeCase, boolean sortKeys) {
        ...
        return build(snakeCase, sortKeys, false);
    }
}
